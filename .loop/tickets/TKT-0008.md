# TKT-0008: Branch parser N/E/M SECTION LEVELHOLD

Status: Blocked
Owner session: Ticket Implementation Session
Review session: Design Review Session
Worktree: `worktrees/impl/TKT-0008`

## 1. Objective

Implement branch syntax parser and branch lane model.
...
- Parse SECTION, BRANCHSTART, N/E/M, LEVELHOLD, BRANCHEND.
- Build common/normal/expert/master route structures.
- Log branch sections.
...
- Branch parser fixtures pass.
- Route sections are visible in timing log.
