...
Worktree: `worktrees/impl/TKT-0013`

## 1. Objective

Implement parse/report compatibility for SUDDEN, DIRECTION, and JPOSSCROLL. Gameplay-complete visual reproduction is not required for Phase1, but parse crash is forbidden.
...
- Parse commands into compatibility/display event model.
- Emit report entries.
- Keep headless autoplay stable.
...
- Parse/report fixture passes.
- No crash on special display fixture.
