# TKT-0011: Score gauge and clear model

Status: Blocked
Owner session: Ticket Implementation Session
Review session: Design Review Session
Worktree: `worktrees/impl/TKT-0011`

## 1. Objective

Implement score, gauge, and clear state sufficient for Phase1 validation and branch conditions.
...
- Parse SCOREMODE/SCOREINIT/SCOREDIFF.
- Apply GOGO multiplier and big-note score behavior.
- Track gauge and clear state.
- Expose score/gauge in timing log.
