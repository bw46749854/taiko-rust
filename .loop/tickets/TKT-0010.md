# TKT-0010: Headless autoplay baseline

Status: Blocked
Owner session: Ticket Implementation Session
Review session: Design Review Session
Worktree: `worktrees/impl/TKT-0010`

## 1. Objective

Implement baseline headless autoplay runner that can finish non-branch, non-scroll core charts and write timing logs.
...
- Provide deterministic autoplay.
- Emit timing log schema.
- Return nonzero exit on crash/analyzer-blocking anomaly.
...
- Core autoplay completes.
- Timing log is generated.
